...
- `minecraft-i18n.instructions.md`：玩家可见文本、语言文件和消息映射。
- `configuration-persistence.instructions.md`：配置类、具体数值和配置文件维护。
- `imyvm-mechanism-tech-principles.instructions.md`：IMYVM 机制资源交易与结算技术原则。
- `commands-suggestions.instructions.md`：命令注册和参数建议。
- `documentation-validation.instructions.md`：README、验证命令和 Hoki API。
